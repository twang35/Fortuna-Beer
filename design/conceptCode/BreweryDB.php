...
try {
    $results = $bdb->request('beer/random', $params, 'GET'); // where $params is a keyed array of parameters to send with the API call.
} catch (Exception $e) {
    $results = array('error' => $e->getMessage());
}
$json = $bdb->getLastParsedResponse();
$data = $json['data'];
$style = $data['style'];
...
$beerIsOrganic = $data['isOrganic'];
$beerStyle = $style['name'];
$beerCategory = $category['name'];
$styleDescription = $style['description'];
$beerIBUMin = $style['ibuMin'];
$beerIBUMax = $style['ibuMax'];
$beerABVMin = $style['abvMin'];
$beerABVMax = $style['abvMax'];
$beerSRMMin = $style['srmMin'];
$beerSRMMax = $style['srmMax'];
$beerFGMin = $style['fgMin'];
$beerFGMax = $style['fgMax'];

$returnString = $beerName;
$returnString = '<br>';
$returnString .= $beerDescription;
